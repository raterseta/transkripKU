...
<?php endif; ?>
        ...
        <main class="flex items-center justify-center bg-[url('/public/images/filkom-50.png')] bg-cover bg-center min-h-screen px-4">
            <div class="text-center max-w-2xl w-full py-20 sm:py-10 space-y-1 rounded-xl">
                ...
                <!-- Judul dan Subjudul -->
                <p class="text-base font-semibold font-poppins sm:text-4xl text-gray-900">Selamat Datang di Website</p>
                <h1 class="text-3xl sm:text-6xl font-bold font-poppins text-gray-900">TranskripKU</h1>
