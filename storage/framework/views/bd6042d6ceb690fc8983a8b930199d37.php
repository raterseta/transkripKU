    ...
    <div class="flex flex-col lg:flex-row lg:space-x-10 space-y-4 lg:space-y-0">
      ...
      <div class="flex-1 flex flex-col space-y-4">
        <div class="space-y-2 text-left">
          ...
          <input id="student_name" name="student_name" type="text" placeholder="Nama lengkap" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-300 font-poppins" required />
        </div>
        <div class="space-y-2 text-left">
          <label class="font-semibold font-poppins" for="student_nim">NIM <span class="text-red-500">*</span></label>
          <input id="student_nim" name="student_nim" type="number" placeholder="NIM" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-300 font-poppins" required/>
        </div>
        <div class="space-y-2 text-left">
          <label class="font-semibold font-poppins" for="student_email">Email Aktif <span class="text-red-500">*</span></label>
          <input id="student_email" name="student_email" type="email" placeholder="Email" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-300 font-poppins" required/>
        </div>
      </div>
      ...
      <div class="flex-1 flex flex-col space-y-4">
        <div class="space-y-2 text-left">
          <label class="font-semibold font-poppins" for="needs">Keperluan Transkrip Akademik <span class="text-red-500">*</span></label>
          <select id="needs" name="needs" class="w-full border px-3 py-2 rounded-md border-gray-300 focus:ring-2 focus:ring-orange-300 text-sm font-poppins" required>
          ...
          <input type="text" id="other_needs" name="other_needs" class="mt-2 w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-300 font-poppins hidden" placeholder="Tulis keperluan lainnya...">
        </div>
        ...
        <div class="flex flex-col md:flex-row md:space-x-8 space-y-4 md:space-y-0">
          <div class="space-y-2 w-full">
            ...
            <div class="flex flex-col space-y-2">
              <label class="flex items-center space-x-2">
                <input type="radio" name="language" value="indonesia" class="accent-orange-500" required/>
                <span>Bahasa Indonesia</span>
              </label>
              <label class="flex items-center space-x-2">
                <input type="radio" name="language" value="inggris" class="accent-orange-500" />
          ...
          <div class="space-y-2 w-full">
            ...
            <div class="flex flex-col space-y-2">
              <label class="flex items-center space-x-2">
                <input type="radio" name="signature_type" value="basah" class="accent-orange-500" required/>
                <span>Basah</span>
              </label>
              <label class="flex items-center space-x-2">
                <input type="radio" name="signature_type" value="digital" class="accent-orange-500" />
                <span>Digital</span>
              </label>
            </div>
          </div>
    ...
    <div class="flex flex-col lg:flex-row justify-between">
      <div>
        <label class="block">
          ...
          <input id="supporting_document_url" name="supporting_document_url" type="file" accept=".pdf,.jpg,.jpeg,.png" class="block w-full mt-1 text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-2 file:border-orange-500 file:text-sm file:font-semibold file:bg-white file:text-orange-700 hover:file:bg-orange-100" />
        </label>
      </div>
      <!-- Submit -->
      <div class=" flex sm:flex-row lg:flex-row lg:justify-end items-end pt-6 space-y-4 lg:space-y-0 lg:space-x-4">
        <button type="button" id="submitBtn" class="w-full px-4 py-2 font-semibold text-white bg-orange-500 rounded-md hover:bg-orange-600 transition">Submit</button>
      </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\transkripKU\resources\views/mahasiswa/pengajuan/pengajuan.blade.php ENDPATH**/ ?>