...
<?php endif; ?>
    ...
    <main class="flex items-center justify-center px-4 mt-10 sm:px-6 lg:px-8">
      <div class="flex flex-col w-full max-w-3xl pb-24 space-y-6">
        ...
        <form
          id="formPengajuan"
          method="POST" action="/pengajuan" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
            <!-- Form Box -->
            ...
            <div class="flex flex-row space-x-2 lg:space-x-10">
              ...
              <div class="flex-col space-y-4">
                <div class="space-y-2 text-left">
                  <label class="font-semibold font-poppins" for="nama">Nama Lengkap <span class="text-red-500">*</label>
                  <input id="nama" name="nama" type="text" placeholder="Nama lengkap" class="w-full px-3 py-2 text-sm border border-gray-300 border-solid rounded-md focus:outline-none focus:ring-2 focus:ring-orange-300 font-poppins" required />
                </div>
                <div class="space-y-2 text-left">
                  <label class="font-semibold font-poppins" for="nim">NIM <span class="text-red-500">*</label>
                  <input id="nim" name="nim" type="number" placeholder="NIM" class="w-full px-3 py-2 text-sm border border-gray-300 border-solid rounded-md focus:outline-none focus:ring-2 focus:ring-orange-300 font-poppins" required/>
                </div>
                <div class="space-y-2 text-left">
                  <label class="font-semibold font-poppins" for="email">Email Aktif <span class="text-red-500">*</label>
                  <input id="email" name="email" type="email" placeholder="Email" class="w-full px-3 py-2 text-sm border border-gray-300 border-solid rounded-md focus:outline-none focus:ring-2 focus:ring-orange-300 font-poppins" required/>
                </div>
              </div>
              <!-- Col 2 -->
              <div class="flex flex-col space-y-4">
                <div class="flex flex-col space-y-2 text-left">
                  <label class="font-semibold font-poppins" for="keperluan">Keperluan Transkrip Akademik <span class="text-red-500">*</label>
                  <select id="keperluan" name="keperluan" class="lg:w-[340px] w-[240px] border-solid px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-300 text-sm font-poppins" required>
                ...
                <div class="flex flex-row space-x-8">
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="flex flex-col space-y-4">
                      <label class="flex items-center space-x-1">
                        <input type="radio" id="bahasa" name="bahasa" value="Indonesia" class="accent-orange-500" required/>
                        <span>Bahasa Indonesia</span>
                      </label>
                      <label class="flex items-center space-x-1">
                        <input type="radio" id="bahasa" name="bahasa" value="Inggris" class="accent-orange-500" />
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="flex flex-col space-y-4">
                      <label class="flex items-center space-x-1">
                        <input type="radio" id="ttd" name="ttd" value="Basah" class="accent-orange-500" required/>
                        <span>Basah</span>
                      </label>
                      <label class="flex items-center space-x-1">
                        <input type="radio" id="ttd" name="ttd" value="Digital" class="accent-orange-500" />
                        <span>Digital</span>
                      </label>
                    </div>
                  </div>
...
<?php /**PATH C:\xampp\htdocs\testingv2\resources\views/mahasiswa/pengajuan/pengajuan.blade.php ENDPATH**/ ?>