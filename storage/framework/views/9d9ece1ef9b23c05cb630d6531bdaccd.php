...
<head>
    ...
    <title>Permintaan Transkrip Final Selesai</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>Permintaan Transkrip Final Selesai</h1>
        </div>

        <div class="content">
            <p>Halo <strong><?php echo e($request->student_name); ?></strong>,</p>

            <p>Dengan senang hati kami informasikan bahwa permintaan transkrip final Anda telah <strong>selesai diproses</strong>. Transkrip dapat diambil di Bagian Akademik dengan menunjukkan nomor tracking Anda.</p>
...
<?php /**PATH /Users/pais/Documents/Kuliah/Semester 5/capstone/transkripKU/resources/views/emails/thesis-request-completed.blade.php ENDPATH**/ ?>