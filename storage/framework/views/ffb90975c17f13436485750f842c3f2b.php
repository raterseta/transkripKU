...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-4 font-poppins flex flex-row justify-center lg:w-[870px] md:w-[740px]">
        <div class="p-4 bg-white shadow rounded-xl transition transform ">
            ...
            <div class="text-3xl font-bold"><?php echo e($this->getData()['baru']); ?></div>
        </div>

        <div class="p-4 bg-white shadow rounded-xl transition transform ">
            <div class="text-sm text-gray-500">Diproses</div>
            <div class="text-3xl font-bold"><?php echo e($this->getData()['diproses']); ?></div>
        </div>

        <div class="p-4 bg-white shadow rounded-xl transition transform ">
            <div class="text-sm text-gray-500">Revisi</div>
            <div class="text-3xl font-bold"><?php echo e($this->getData()['revisi']); ?></div>
        </div>

        <div class="p-4 bg-white shadow rounded-xl transition transform ">
            <div class="text-sm text-gray-500">Selesai</div>
            <div class="text-3xl font-bold"><?php echo e($this->getData()['selesai']); ?></div>
        </div>
    </div>
...
<?php /**PATH /Users/pais/Documents/Kuliah/Semester 5/capstone/transkripKU/resources/views/filament/widgets/status-permohonan-overview.blade.php ENDPATH**/ ?>