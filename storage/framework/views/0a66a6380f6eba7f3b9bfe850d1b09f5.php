<nav class="bg-[#002849] font-poppins text-white" x-data="{ isMobileOpen: false }">
    <div class="mx-auto w-full px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between px-0">
            <!-- Logo -->
    ...
    <div class="sm:hidden px-4 pt-2 pb-4 space-y-2" x-show="isMobileOpen" x-transition>
        ...
        <a href="<?php echo e(url('/admin/login')); ?>" class="flex items-center space-x-2">
            <img src="<?php echo e(asset('images/user.svg')); ?>" alt="My SVG" class="w-6 h-6" />
            <span>Admin</span>
        </a>
    </div>
</nav>
<?php /**PATH C:\xampp\htdocs\transkripKU\resources\views/components/navbar-home.blade.php ENDPATH**/ ?>