<nav class="bg-[#002849]" x-data="{ isMobileOpen: false, isLaptopOpen: false }">
                ...
                <!--Tab Nav 1-->
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div class="relative ml-3 flex flex-row">
                            ...
                            <div>
                                <button class="inline-flex text-sm leading-4 font-medium rounded-md text-white hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
        ...
        </nav><?php /**PATH C:\xampp\htdocs\transkripKU\resources\views/components/navbar-home.blade.php ENDPATH**/ ?>