...
<body>
    <div class="container">
        <div class="header">
            <h1>Permintaan Transkrip Final Berhasil</h1>
        </div>

        <div class="content">
            <p>Halo <strong><?php echo e($request->student_name); ?></strong>,</p>

            <p>Terima kasih telah mengajukan permintaan transkrip final di TranskripKU. Permintaan Anda telah berhasil diterima dan sedang diproses.</p>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e(url('/track/show?id=' . $request->tracking_number)); ?>" class="btn">Lacak Permintaan</a>
            </div>
        </div>
...
<?php /**PATH /Users/pais/Documents/Kuliah/Semester 5/capstone/transkripKU/resources/views/emails/thesis-request.blade.php ENDPATH**/ ?>