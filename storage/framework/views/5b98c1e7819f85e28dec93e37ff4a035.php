                        ...
                        <?php $__currentLoopData = $tracks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $track): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex mb-8 relative">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-base text-orange-600"><?php echo e($track->action_desc); ?></p>
                                    <?php break; ?>
                                    ...
                                    <p class="text-base text-red-600"><?php echo e($track->action_desc); ?></p>
                                    <?php break; ?>
                                    ...
                                    <p class="text-base text-gray-400"><?php echo e($track->action_desc); ?></p>
                                    <?php endswitch; ?>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/pais/Documents/Kuliah/Semester 5/capstone/transkripKU/resources/views/mahasiswa/track/result.blade.php ENDPATH**/ ?>