    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="consultation-section">
                ...
                <p><strong>Tanggal & Waktu:</strong> {{ $request->consultation_date->format('d M Y, H:i') }}</p>

                @if($request->consultation_notes)
            ...
            <div style="text-align: center;">
                @if($recipientRole === 'kaprodi')
                    <a href="{{ url('/admin/transkrip-final/' . $request->id . '/edit') }}" class="btn">Lihat Detail Pengajuan</a>
                @else
