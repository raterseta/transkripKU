...
<head>
    ...
    <title>Permintaan Transkrip Akademik Ditolak</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>Permintaan Transkrip Akademik Ditolak</h1>
        </div>

        <div class="content">
            <p>Halo <strong>{{ $request->student_name }}</strong>,</p>

            <p>Mohon maaf, permintaan transkrip akademik Anda <strong>tidak dapat diproses</strong> saat ini.</p>
